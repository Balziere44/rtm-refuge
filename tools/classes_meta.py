...
CLASSES = [
    ...
    dict(slug="orphan", page="Orphan", tier="orphan", parents=[], leads_to=[
        ...
        tagline="Everyone starts here. Nobody stays.",
        refuge=[
    ...
    dict(slug="thief", page="Thief", tier="first", parents=["orphan"],
         ...
         tagline="The main road. Melee, magic and ranged in one tree.",
         refuge=[
    ...
    dict(slug="trickster", page="Trickster", tier="first", parents=["orphan"],
         leads_to=["revenant"],
         tagline="Scythes, innate leech, and a three-step combo you never stop pressing.",
    ...
    dict(slug="jester", page="Jester", tier="first", parents=["orphan"], leads_to=[],
         tagline="A deck, a huge SP pool, and the highest attack speed ceiling in the game.",
    ...
    dict(slug="ronin", page="Ronin", tier="first", parents=["orphan"], leads_to=[],
         tagline="Every skill can crit. Every hit taken takes your buffs with it.",
    ...
    dict(slug="vagabond", page="Vagabond", tier="first", parents=["orphan"],
         leads_to=["legend"],
         tagline="Daggers and auto attacks. No rotation, no excuses.",
    ...
    dict(slug="raider", page="Raider", tier="first", parents=["orphan"],
         ...
         tagline="Spears, staying power, and a trial that ends in a dragon.",
    ...
    dict(slug="judge", page="Judge", tier="expert", parents=["orphan"], leads_to=[],
         tagline="Revolvers you craft yourself, and 100 job levels to fill.",
    ...
    dict(slug="illusionist", page="Illusionist", tier="expert", parents=["orphan"], leads_to=[],
         tagline="Two characters in one. Yours, and Kimi's.",
    ...
    dict(slug="dark-knight", page="Darkknight", tier="expert", parents=["orphan"], leads_to=[],
         tagline="The lower your health, the harder you hit.",
    ...
    dict(slug="assassin", page="Assassin", tier="second", parents=["thief"],
         ...
         tagline="Path of Tradition. Swords, axes, katars and shadows.",
    ...
    dict(slug="rogue", page="Rogue", tier="second", parents=["thief"],
         ...
         tagline="Path of Change. Four different characters live in this tree.",
    ...
    dict(slug="prowler", page="Prowler", tier="alt", parents=["thief"], leads_to=[],
         tagline="Abandon the path. Flee, perfect dodge, and a better Backstab.",
    ...
    dict(slug="shadowseer", page="Shadowseer", tier="alt", parents=["thief"], leads_to=[],
         tagline="Melee that spends magic. Autocast until something dies.",
    ...
    dict(slug="dracomancer", page="Dracomancer", tier="final", parents=["raider"], leads_to=[],
         tagline="Draco Orbs instead of runes, and a dragon you can borrow.",
    ...
    dict(slug="revenant", page="Revenant", tier="final", parents=["trickster"], leads_to=[],
         tagline="Lady Hel's subject. Counters, leech, and a spirit that stuns.",
    ...
    dict(slug="legend", page="Legend", tier="final", parents=["vagabond"], leads_to=[],
         tagline="Dual wielding, and passives on top of passives.",
         refuge=["Only touched indirectly, through the shared passives."]),
    dict(slug="pit-boss", page=None, tier="final", parents=["bouncer"], leads_to=[],
         tagline="Big setup, big hits. Golf clubs and chains.",
    ...
    dict(slug="night-raven", page="Night_Raven", tier="final", parents=["blade-dancer"], leads_to=[],
         tagline="Every assassin weapon, plus a hawk that never misses.",
    ...
    dict(slug="satsujin", page="Satsujin", tier="final", parents=["shinobi"], leads_to=[],
         tagline="Melee, magic and ranged trees at once. Jack of all trades.",
    ...
    dict(slug="gravekeeper", page="Gravekeeper", tier="final", parents=["executioner"], leads_to=[],
         tagline="Loki's legacy. Crit damage, and no defensive options at all.",
    ...
    dict(slug="black-plague", page="Black_Plague", tier="final", parents=["scoundrel"], leads_to=[],
         tagline="Double axes and diseases. Kills bosses from the inside.",
    ...
    dict(slug="arcane-master", page="Arcanemaster", tier="final", parents=["mystic"], leads_to=[],
         tagline="Unrestricted magic, plus a tree that revives the party.",
    ...
    dict(slug="kingslayer", page="Kingslayer", tier="final", parents=["duelist"], leads_to=[],
         tagline="Chess. A left tree that kills, a right tree that survives.",
    ...
    dict(slug="blast-juggler", page="Blast_Juggler", tier="final", parents=["saboteur"], leads_to=[],
         tagline="Rules? Explosions are the only option.",
    ...
    dict(slug="sinner", page="Sinner", tier="final", parents=["deadeye"], leads_to=[],
         tagline="Repent through cleansing. Auto attack, turret or manual cast.",
    ...
    dict(slug="unchained-thief", page="Unchained_Evolutions", section="Unchained Thief",
         ...
         tagline="The Super Novice of this world. Core skills from both second jobs.",
         refuge=[]),
    dict(slug="unchained-assassin", page="Unchained_Evolutions", section="Unchained Assassin",
         tier="alt", parents=["assassin"], leads_to=[],
         tagline="Break the limit, lock the job, master the basics.", refuge=[]),
    ...
    dict(slug="phantom-thief", page="Unchained_Evolutions", section="Phantom Thief",
         ...
         tagline="Infinite possibilities. Most specialisation skills, and every job's shadow set.",
...
NAMES = {
    "orphan": "Orphan", "thief": "Thief", "trickster": "Trickster", "jester": "Jester",
...
TREE = [
    ("The Thief road",
     "The main progression, and the widest. Ten job levels as an Orphan, fifty as a Thief, "
     "then a choice that eventually forks eight ways.",
     [["thief"], ["assassin", "rogue"],
      ["blade-dancer", "shinobi", "executioner", "scoundrel", "mystic", "duelist", "saboteur", "deadeye"],
      ["night-raven", "satsujin", "gravekeeper", "black-plague",
       "arcane-master", "kingslayer", "blast-juggler", "sinner"]]),
    ("Leaving the road",
     "Thieves can abandon the path entirely. Assassins and Rogues can lock their job "
     "forever instead of specialising.",
     [["prowler", "shadowseer"], ["unchained-thief", "unchained-assassin", "unchained-rogue"],
      ["phantom-thief"]]),
    ("The Raider road",
     "Fast job levels, harsh job quests, and a trial nobody will describe.",
     [["raider"], ["dracomancer"]]),
    ("The unbound",
     "Trickster and Vagabond ignore their destiny in opposite directions. Seventy job "
     "levels each before the final change.",
     [["trickster", "vagabond"], ["revenant", "legend"]]),
    ("Standing alone",
     "Three jobs with no second step. Jester breaks the story, Ronin meditates on it, "
     "Mimic laughs at it.",
     [["jester", "ronin", "mimic"]]),
    ("The Expert jobs",
     "Unique systems, steeper learning curves, and explicitly not recommended for a "
     "first character.",
     [["judge", "peacekeeper", "illusionist", "dark-knight"]]),
    ("New in the Refuge",
     "Two jobs that did not exist before. Same progression timing as Raider to "
     "Dracomancer, so the second step comes quickly.",
     [["bouncer"], ["pit-boss"]]),
]
